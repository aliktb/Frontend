...
let coffees = [
    { orderNumber: 1, Milk: true, Toppings: ["cream, cocoa powder"], size: "small"},
    { orderNumber: 2, Milk: false, Toppings: ["milk froth"], size: "large"},
    { orderNumber: 3, Milk: false, Toppings: ["cream"], size: "medium"},
    { orderNumber: 4, Milk: true, Toppings: ["sprinkles", "cream", "cocoa powder"], size: "large"}
]
...
coffees.push({ orderNumber: 5, Milk: true, Toppings: ["cream, sprinkles"], size: "medium"});
